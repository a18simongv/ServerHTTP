...
public class Pages {
	...
	public static String dniHtml(String addrs) {
		...
		html = header()
				...
				+ "<a href='http://"+ addrs +":"+port+"/dni=35879559'>Example: http://"+ addrs +":"+port+"/dni=35879559</a></pre>"
				+ "<pre>	2.<a href='http://"+ addrs +":"+port+"/'>Go back</a></pre>"
				+ "</body>";
	...
	public static String errorDniHtml(String addrs) {
		...
		html = header()
				+ "<body>"
				+ "<h1>&#33;ERROR! DNI didn't valid</h1>"
				+ "<p><a href='http://"+ addrs +":"+port+"/'>Go back</a></p>"
				+ "</body>";
